...
`linux-amd64`, `linux-aarch64`, `freebsd-amd64`, `netbsd-amd64`) — each
contains the binary, README, and LICENSE. The BSD builds run in emulated VMs
and are attached to the release shortly after it's published.

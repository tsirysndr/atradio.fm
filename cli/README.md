...
```bash
# amd64
curl -LO https://github.com/tsirysndr/atradio.fm/releases/latest/download/atradio_0.4.0_amd64.deb
sudo apt install ./atradio_0.4.0_amd64.deb

# arm64 (Raspberry Pi 4/5, Apple-silicon VM, …)
curl -LO https://github.com/tsirysndr/atradio.fm/releases/latest/download/atradio_0.4.0_arm64.deb
sudo apt install ./atradio_0.4.0_arm64.deb
```
...
```bash
sudo dnf install \
  https://github.com/tsirysndr/atradio.fm/releases/latest/download/atradio-0.4.0-1.x86_64.rpm
```
